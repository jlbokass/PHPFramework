...
class User extends Model
{
     ...
     *
     * @return bool  True if the user was saved, false otherwise
     */
     ...
     */
    public static function emailExists(string $email, int $ignore_id = null): bool
    {
    ...
    {
        $url = 'http://' . $_SERVER['HTTP_HOST'] . '/PHPFramework/password/reset/' . $this->password_reset_token;

        $text = View::getTemplate('Password/reset_email.txt', ['url' => $url]);
        $html = View::getTemplate('Password/reset_email.html', ['url' => $url]);

        Mail::sent($this->email, 'Password reset', $text, $html);
    }
    ...
    {
        $url = 'http://' . $_SERVER['HTTP_HOST'] . '/PHPFramework/signup/activate/' . $this->activation_token;

        $text = View::getTemplate('Signup/activation_email.txt', ['url' => $url]);
        $html = View::getTemplate('Signup/activation_email.html', ['url' => $url]);

        Mail::sent($this->email, 'Account activation', $text, $html);
    }
